function UET(o) {
  ...
  this.checkuetHostdocumentload = function () {
    ...
    if (n.evqCDispatch === !1)
      for (n.dispatchq(!0), n.evqCDispatch = !0, t = 0; t < n.eventPushQueue.length; t++)
        n.eventPushQueue[t] instanceof Array &&
          n.processEarly[n.eventPushQueue[t][0]] &&
    ...
    if (t) {
      ...
      this.uetConfig.tcf.hasLoaded ||
        ...
        this.uetConfig.consent.enforced === !0 &&
          ((this.uetConfig.consent.enabled = !1), (this.uetConfig.consent.enforced = !1)));
      this.fireConsentPing('tcf');
      this.uetLoaded !== !0 && this.checkuetHostdocumentload();
    }
  };
  this.getClUrl = function (n) {
    return (this.uetConfig.consent.enabled === !0 && this.uetConfig.consent.adStorageAllowed === !1) ||
  ...
  this.loadConfig = function () {
    ...
    o.hasOwnProperty('pagePid') && o.pagePid && typeof o.pagePid == 'object'
      ...
      : o.hasOwnProperty('gtagPid') && o.gtagPid === !0 && (this.uetConfig.gtagPid = !0);
    ...
    for (
      this.beaconParams.mid = this.getUuidV4(!0), this.beaconParams.bo = 0, t = undefined, y = 0;
      y < 5;
      y++
    )
      if (((t = 'ueto_' + this.makeRandomStr(10)), !window[t])) break;
    this.stringExists(o.ti) &&
      ((k = ['56004448', '5798164', '20132024', '4000835', '4074038']),
        ...
        navigator.userAgentData.getHighEntropyValues(['platformVersion']).then(
          function (n) {
            n.hasOwnProperty('platformVersion') &&
              ((r.uetConfig.uach = {}), (r.uetConfig.uach.pv = encodeURIComponent(n.platformVersion)));
          },
          function (n) {
    ...
    this.stringExists(this.uetConfig.batDebug) &&
      window.opener &&
      this.stringExists(o.ti) &&
      ((b = 'https://ui.ads.microsoft.com'),
      document.referrer &&
        window.URL &&
        ((c = new URL(document.referrer)),
  ...
  this.push = function () {
    ...
    this.uetInstance.uetLoaded || (this.evqCDispatch && this.processEarly[t])
    ...
    if (n[1] instanceof Array)
      if (n[0] === 'event') {
        ...
        if (
          ...
          this.stringExists(t.source) &&
          t.source.indexOf('gtm_') === 0 &&
          ((o = !0),
          t.source === 'gtm_update' &&
        ...
        f === 'default'
          ? (t.hasOwnProperty('ad_storage') &&
            ...
            t.hasOwnProperty('wait_for_update') &&
              ...
              !isNaN(r) && r > 0 && ((r = Math.min(r, 1e4)), (this.uetConfig.consent.waitForUpdate = r))))
          : f === 'update' &&
            t.hasOwnProperty('ad_storage') &&
            ((this.uetConfig.consent.adStorageAllowed = t.ad_storage !== 'denied'),
      ...
      n ||
        ...
        this.uetConfig.enableAutoSpaTracking === !0 &&
          (('onpopstate' in window) &&
            window.addEventListener('popstate', this.documentUrlChanged.bind(this, 'popstate')),
      ...
      if (typeof this.evq[r] == 'object') {
        ...
        typeof this.evq[r] == 'string' || this.evq[r] instanceof String
          ? (t !== undefined && i !== undefined && (n || this.push(t, i, {}), (t = i = undefined)),
            (f = this.evq[r]),
            t === undefined && (f === 'set' || f === 'consent' || f === 'config' || f === 'event')
              ? (t = f)
  ...
  this.addLoadTime = function (n) {
    ...
    if (
      ...
      window.performance.navigation != null &&
        (n.pn = window.performance.navigation.type + ',' + window.performance.navigation.redirectCount);
    }
    return n;
  };
  ...
  this.addPageData = function (n, t) {
    ...
    return (
      ...
      window.document.head.getElementsByTagName('meta').keywords &&
        ((u = window.document.head.getElementsByTagName('meta').keywords.content),
        this.stringExists(u) && (n.kw = encodeURIComponent(u).replace(/%2C/gi, ','))),
      t
        ? this.stringExists(this.previousPage) && !n.hasOwnProperty('r') && (n.r = this.previousPage)
  ...
  this._validateProdId = function (n) {
    return (
      (n === null || n === undefined) && this.throwError(this.invalidProdIdException),
      (n = n.toString()),
    ...
    if (n instanceof Array) {
      for (t = 0; t < n.length; t++)
        n[t] instanceof Array && this.throwError(this.invalidProdIdException),
          n[t] !== null &&
            n[t] !== undefined &&
            ((i += i !== '' ? ',' : ''), (i += encodeURIComponent(this._validateProdId(n[t]))));
  ...
  this.validateParameter = function (n, t, i) {
    var r, u;
    if (
      (t.match(/^[a-z_]{2,32}$/) || this.throwError(n + ' invalid parameter name'),
  ...
  this.validateDataObjectNew = function (n, t) {
    ...
    if (
      ...
      !t.hasOwnProperty('ecomm_prodid') ||
        t.ecomm_prodid == null ||
        (typeof t.ecomm_prodid == 'string' && t.ecomm_prodid.toString() === '') ||
  ...
  this.validateDataObject = function (n, t) {
    ...
    for (i in t)
      (n === this.customEvt &&
        (this.legacyValidCustomEventKeyNames[i] || this.ambiguousValidCustomEventKeyNames[i])) ||
    ...
    t.hasOwnProperty('gc') > 0 &&
      (t.gc = this.validateRegex(t.gc, /^[a-zA-Z]{3}$/, this.goalCurrencyFormatException));
    t.hasOwnProperty('ec') > 0 &&
      t.ec !== null &&
      t.ec !== undefined &&
      ((r = encodeURIComponent(t.ec)), (t.ec = this.encodeParameter(t.ec)), t.ec !== r && (t.ec2 = r));
    t.hasOwnProperty('ea') > 0 &&
      t.ea !== null &&
      t.ea !== undefined &&
      ((u = encodeURIComponent(t.ea)), (t.ea = this.encodeParameter(t.ea)), t.ea !== u && (t.ea2 = u));
    t.hasOwnProperty('el') > 0 &&
      t.el !== null &&
      t.el !== undefined &&
      ((f = encodeURIComponent(t.el)), (t.el = this.encodeParameter(t.el)), t.el !== f && (t.el2 = f));
    ...
    t.hasOwnProperty('pagetype') > 0
      ? ((t.pagetype = this.validatePageType(t.pagetype, this.validRetailPageTypeValues)),
        t.hasOwnProperty('prodid') > 0 && (t.prodid = this.validateProdId(t.prodid)))
  ...
  this.evt = function (n, t, i, r) {
    ...
    if (
      ...
      if (
        (this.uetConfig.allRep === !0
          ...
          : i.hasOwnProperty('rep') &&
            (i.rep === 1 || i.rep === '1' || i.rep === !0 ? (i.rep = '1') : delete i.rep),
        this.enforceConsent(),
        n === this.pageLoadEvt &&
      ...
      this.pageLevelParams.hasOwnProperty('vid')
        ? ((f = this.pageLevelParams.vid),
          typeof f == 'string' &&
            ...
            f.match(/^[0-9a-f]{32}$/) && ((this.beaconParams.vid = f), (this.beaconParams.vids = '3'))))
      ...
      this.uetConfig.msDns !== !0 &&
        ((this.beaconParams.bo = (this.beaconParams.bo || 0) + 1), this.fireBeacon(i), (i.abf = !0));
      ...
      if (((c = this.getHostname()), c && typeof c == 'string' && c !== 'localhost'))
        for (h = c.split('.'), o = h.pop(), h.length === 3 && Number(o) >= 0 && (h = []); h.length > 0; )
          if (
            ...
            (r && (this._setCookie(n, '', l, o, this.uetConfig.cookieFlags), (r = !!this.getCookie(n, f, e))),
            !r && (this._setCookie(n, f + t, s, o, this.uetConfig.cookieFlags), this.getCookie(n, f, e)))
          ) {
            this.domainName = o;
            return;
          }
  ...
  this.addCookieId = function (n, t, i, r, u) {
    ...
    return (this.stringExists(f) ||
      ((h = !1), (f = this.getLocalStorageBackup(r, this.insightsCookieMaxLength))),
    ...
    return (
      ...
      this.stringExists(this.msClkId)
        ? (this.setCookie(
          ...
          this.getCookie(this.msClkIdCookieName, this.msClkIdCookieValuePrefix, this.lengthMsClkId) !==
            this.msClkId && (i += 'N'),
  ...
  this.fireBeacon = function (n) {
    for (
      ...
      ((i = o[u]), i in t) &&
        (u == 0 ? (t[i] = t[i].split('?')[0]) : u <= 3 ? (t[i] = '') : delete t[i],
        (r = this.stringifyToRequest(t)),
        (f = this.removeTrailingAmp(e + r)));
  ...
  this.buildConsentDetectionBlob = function () {
    ...
    return btoa(String.fromCharCode(1, n.cmp, u))
      .replace('+', '-')
      .replace('/', '_')
      .replace(/={1,2}$/, '');
  };
  this.shouldEnforce = function (n) {
    return this.uetConfig.consent.enabled === !0 ||
      (this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0)
      ? !1
      : this.uetConfig.cusig.blob.bi === !0
        ? !0
        : this.uetConfig.cusig.blob.ec === !0
          ? this.uetConfig.cusig.blob.dt === !0
            ? !0
            : this.uetConfig.cusig.blob.at === !0
              ? !1
              : n.hasCookie === !1
                ? !0
                : !1
  ...
  this.enforceConsent = function () {
    ...
    this.shouldEnforce(n)
      ? ((this.uetConfig.consent.enabled = !0),
        ...
        delete this.beaconParams.vids,
        delete this.beaconParams.msclkid,
        t !== !0 && this.fireConsentPing('enforced'))
      : n.hasCookie === !0 &&
        this.uetConfig.consent.enforced === !0 &&
        ((this.uetConfig.consent.enabled = !1),
        (this.uetConfig.consent.enforced = !1),
        t !== !1 && this.fireConsentPing('unenforced'));
  };
  this.addConsentParams = function (n) {
    if (
      (this.uetConfig.consent.enabled === !0 && (n.asc = this.uetConfig.consent.adStorageAllowed ? 'G' : 'D'),
      this.uetConfig.tcf.enabled === !0)
    ) {
      var t = {
      ...
      if (
        ...
        for (r = 0; r < n.transactionProducts.length; r++)
          ((t = n.transactionProducts[r]), typeof t == 'object') &&
            ((i = {}),
            t.hasOwnProperty('sku') && ((i.id = t.sku), n.ecomm_prodid.push(i.id)),
    ...
    if (n.hasOwnProperty('ecommerce') && typeof n.ecommerce == 'object') {
      ...
      if (
        ...
        t.hasOwnProperty('actionField') &&
          ...
          (t.actionField.hasOwnProperty('id') && (n.transaction_id = t.actionField.id),
        ...
        for (n.ecomm_prodid = [], n.items = [], u = 0; u < t.products.length; u++)
          ((i = t.products[u]), typeof i == 'object') &&
            ((r = {}),
            i.hasOwnProperty('id') && ((r.id = i.id), n.ecomm_prodid.push(r.id)),
    ...
    if (
      ...
      for (n.ecomm_prodid = [], u = [], r = 0; r < n.items.length; r++)
        ((t = n.items[r]), typeof t == 'object') &&
          ((i = {}),
          (t.item_id || t.id) && ((i.id = t.item_id || t.id), n.ecomm_prodid.push(i.id)),
          t.hasOwnProperty('price') && (i.price = t.price),
          t.hasOwnProperty('quantity') && (i.quantity = t.quantity),
          u.push(i));
      n.items = u;
  ...
  this.insightsGetCookie = function (n) {
    ...
    return (
      this.stringExists(t) || (t = this.getLocalStorageBackup(i, this.insightsCookieMaxLength)),
  ...
  this.setExternalMid = function (n) {
    this.stringExists(n) &&
      ...
      ((this.beaconParams.mid = n), (this.beaconParams.bo = 0), (this.midOverride = !0));
  };
  this.setUserSignals = function (n) {
    typeof n == 'object' && n !== null && ((this.uetConfig.cusig.blob = n), this.enforceConsent());
    this.uetConfig.cusig.hasLoaded ||
      ((this.uetConfig.cusig.hasLoaded = !0),
  ...
  this.isDuplicate(o)
    ? ((this.uetInstance = o.q), navigator.sendBeacon && this.uetInstance.fireSendBeacon('dedup'))
    : (this.loadConfig(), this.checkuetHostdocumentload());
}
function UET_init(u, o) {
  (typeof window[u] != 'object' || Object.prototype.toString.call(window[u]) === '[object Array]') &&
